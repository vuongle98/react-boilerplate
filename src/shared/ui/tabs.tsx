  ...
  return (
    <TabsPrimitive.List
      ...
      className={cn(
        ...
        isMobile ? "flex-col h-auto p-2 gap-1" : "inline-flex h-10 p-1",
        className
      )}
      {...props}
    />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        isMobile
          ? " rounded-md px-4 py-2.5 text-sm min-h-[44px] data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm active:scale-[0.98]"
