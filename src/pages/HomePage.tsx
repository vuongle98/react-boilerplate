...
export const HomePage = () => {
  ...
  const features = [
    {
      ...
      description: "Complete CRUD operations with advanced filtering, pagination, and real-time updates",
      color: "text-blue-500"
    },
    {
      icon: <Database className="h-6 w-6" />,
      title: "Smart Caching",
      description: "Intelligent data caching with React Query for optimal performance",
      color: "text-green-500"
    },
    {
      icon: <Shield className="h-6 w-6" />,
      title: "Authentication",
      description: "Secure Keycloak integration with protected routes and role-based access",
      color: "text-purple-500"
    },
    {
      icon: <Layers className="h-6 w-6" />,
      title: "Component Library",
      description: "Comprehensive shadcn/ui components with dark mode and accessibility",
      color: "text-orange-500"
    },
    {
      icon: <Zap className="h-6 w-6" />,
      title: "Modern Architecture",
      description: "Feature-based structure with TypeScript, clean separation of concerns",
      color: "text-yellow-500"
    },
    {
      icon: <BarChart3 className="h-6 w-6" />,
      title: "Data Visualization",
      description: "Rich tables, charts, and interactive data displays with loading states",
      color: "text-red-500"
    }
  ];
  ...
  const stats = [
    ...
    { label: "Responsive", value: "Mobile-first", icon: <Smartphone className="h-4 w-4" /> },
    { label: "Performance", value: "Optimized", icon: <Zap className="h-4 w-4" /> }
  ];
                ...
                {[1, 2, 3].map((i) => (
                  <Card key={i} className="hover:shadow-lg transition-shadow">
                    <CardHeader>
                      ...
                      <CardDescription>
                        Clean, accessible card components with hover effects and proper spacing.
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
          ...
          <FadeUp delay={300}>
            ...
            <Card className="bg-white dark:bg-neutral-900">
              <CardHeader>
                ...
                <CardDescription>
                  Responsive tables with loading states, pagination, and interactive elements
                </CardDescription>
              </CardHeader>
              <CardContent>
                <DataTable
      ...
      <footer className="py-12 bg-neutral-900 text-neutral-300">
        <div className="page-container">
          <div className="grid gap-8 md:grid-cols-4">
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold text-white">React Boilerplate</span>
              </div>
              <p className="text-sm">
                A modern, feature-rich React application boilerplate built with best practices and cutting-edge technologies.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link to="/bots" className="hover:text-white transition-colors">Bots Demo</Link></li>
          ...
          <div className="border-t border-neutral-700 mt-8 pt-8 text-center text-sm">
            <p>&copy; 2024 React Boilerplate. Built with modern web technologies.</p>
          </div>
        </div>
      </footer>
    </div>
